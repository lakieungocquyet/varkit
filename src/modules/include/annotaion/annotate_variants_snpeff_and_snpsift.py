...
def annotate_genome_snpeff(input_file, outdir, output_file):
    ...
    with (
        ...
        subprocess.run(
            [
                ...
                "snpeff", "-v", "GRCh37.p13", input_file_path
            ], 
            stdout=outfile,
...
def annotate_variant_type_snpsift(input_file, outdir, output_file):
    input_file_path = f"{outdir}/{input_file}"
    output_file_path = f"{outdir}/{output_file}"
    runtime_log_path = f"{outdir}/runtime.log"
    monitor_log_path = f"{outdir}/monitoring.log"
    with (
        ...
        subprocess.run(
            [
                ...
                "-o", runtime_log_path,
                "-f", "Elapsed: %E\nMaximum resident set size (kB): %M\nExit status: %x\n",
                "snpsift", "varType", input_file_path
            ], 
            stdout=outfile,
            stderr=monitoring_log,
            shell=False, 
...
def annotate_clinvar_snpsift(input_file, outdir, output_file):
    input_file_path = f"{outdir}/{input_file}"
    output_file_path = f"{outdir}/{output_file}"
    runtime_log_path = f"{outdir}/runtime.log"
    monitor_log_path = f"{outdir}/monitoring.log"
...
def annotate_p3_1000g_snpsift(input_file, outdir, output_file):
    input_file_path = f"{outdir}/{input_file}"
    output_file_path = f"{outdir}/{output_file}"
    runtime_log_path = f"{outdir}/runtime.log"
    monitor_log_path = f"{outdir}/monitoring.log"
...
def annotate_dbsnp_snpsift(input_file, outdir, output_file):
    input_file_path = f"{outdir}/{input_file}"
    output_file_path = f"{outdir}/{output_file}"
    runtime_log_path = f"{outdir}/runtime.log"
    monitor_log_path = f"{outdir}/monitoring.log"
    with (
        ...
        subprocess.run(
            [
                ...
                "-o", runtime_log_path,
                "-f", "Elapsed: %E\nMaximum resident set size (kB): %M\nExit status: %x\n",
                "snpsift", "annotate", "-noId", 
                "-info", "dbSNP138_ID,dbSNPBuildID", 
                "-id",
...
def annotate_dbnsfp_snpsift(input_file, outdir, output_file):
    input_file_path = f"{outdir}/{input_file}"
    output_file_path = f"{outdir}/{output_file}"
    runtime_log_path = f"{outdir}/runtime.log"
    monitor_log_path = f"{outdir}/monitoring.log"
    with (
        ...
        subprocess.run(
            [
                ...
                "-db", 
                "/home/lknq/anotation/dbNSFP/dbNSFP4.1a.txt.gz",
                input_file_path
            ], 
            stdout=outfile,
            stderr=monitoring_log,
