...
def annotate_genome_snpeff(input_file, xms, xmx, outdir, output_file):
    env = os.environ.copy()
    env["JAVA_TOOL_OPTIONS"] = f"-Xms{xms} -Xmx{xmx} -XX:+UseG1GC"
...
def annotate_variant_type_snpsift(input_file, xms, xmx, outdir, output_file):
    env = os.environ.copy()
    env["JAVA_TOOL_OPTIONS"] = f"-Xms{xms} -Xmx{xmx} -XX:+UseG1GC" 
    input_file_path = f"{outdir}/{input_file}"
    output_file_path = f"{outdir}/{output_file}"
...
def annotate_clinvar_snpsift(input_file, xms, xmx, clinvar_data, outdir, output_file):
    env = os.environ.copy()
    env["JAVA_TOOL_OPTIONS"] = f"-Xms{xms} -Xmx{xmx} -XX:+UseG1GC" 
    input_file_path = f"{outdir}/{input_file}"
    output_file_path = f"{outdir}/{output_file}"
...
def annotate_p3_1000g_snpsift(input_file, xms, xmx, p3_1000g_data, outdir, output_file):
    env = os.environ.copy()
    env["JAVA_TOOL_OPTIONS"] = f"-Xms{xms} -Xmx{xmx} -XX:+UseG1GC"
    input_file_path = f"{outdir}/{input_file}"
    output_file_path = f"{outdir}/{output_file}"
...
def annotate_dbsnp_snpsift(input_file, xms, xmx, dbsnp_data, outdir, output_file):
    env = os.environ.copy()
    env["JAVA_TOOL_OPTIONS"] = f"-Xms{xms} -Xmx{xmx} -XX:+UseG1GC"
    input_file_path = f"{outdir}/{input_file}"
    output_file_path = f"{outdir}/{output_file}"
...
def annotate_dbnsfp_snpsift(input_file, xms, xmx, dbnsfp_data, outdir, output_file):
    env = os.environ.copy()
    env["JAVA_TOOL_OPTIONS"] = f"-Xms{xms} -Xmx{xmx} -XX:+UseG1GC" 
    input_file_path = f"{outdir}/{input_file}"
    output_file_path = f"{outdir}/{output_file}"
