...
GENERAL_INFO =  ["CHROM","POS","REF","ALT","DP","AD","QUAL","MQ","Zygosity","FILTER","Effect","Putative_Impact","Gene_Name","Feature_Type","Feature_ID",
                "Transcript_BioType","Rank/Total","HGVS.c","HGVS.p","REF_AA","ALT_AA","cDNA_pos","cDNA_length","CDS_pos","CDS_length","AA_pos","AA_length","Distance"
                ]
...
VCF_FILE = VCF("/home/lknq/TEST/RGNC07/RGNC07.final.vcf")
data = []
HEADER = GENERAL_INFO + DB_SNP_INFO + ONE_THOUSAND_GENOMES_INFO + EVS_INFO + CLINVAR_INFO + DB_NSFP_INFO
TOTAL_RECORD = sum(1 for _ in VCF("/home/lknq/TEST/RGNC07/RGNC07.final.vcf"))
...
with pd.ExcelWriter("/home/lknq/TEST/RGNC07/RGNC07.final.xlsx", engine="xlsxwriter") as writer:
